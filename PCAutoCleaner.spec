...
a = Analysis(
    ...
    hiddenimports=['PyQt5.QtNetwork', 'PyQt5.QtCore', 'PyQt5.QtWidgets', 'PyQt5.QtGui', 'psutil', 'winreg', 'core.security_scanner', 'core.hardware_monitor', 'core.ai_advisor', 'core.service_optimizer', 'core.context_menu_manager', 'core.uninstaller_manager', 'core.winsxs_cleaner', 'ui.hardware_dialog', 'ui.ai_advisor_dialog', 'ui.service_context_dialog', 'ui.uninstaller_dialog', 'ui.winsxs_dialog'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
